      ...
      <div className="md:flex items-center justify-center">
        <div>
          ...
          <p className="text-sm leading-7 text-gray max-w-sm">
            ...
            voluptatum ex blanditiis officia consequatur error architecto
            mollitia, facilis temporibus sapiente.
          </p>
          <div className="mt-6">
            <button className="px-6 py-3 font-bold text-white bg-Teal hover:bg-teal-900 rounded-lg mr-4 text-sm">
              Get Started
            </button>
